...
- Media (Video and Audio)
- Forms
- action and method (POST/GET) attributes
- Form Attributes

## Reflection

This project helped me develop a better understanding of working with images, hyperlinks, multimedia elements (video and audio), HTML forms, and form attributes. It also reinforced the importance of creating interactive and user-friendly web pages.
